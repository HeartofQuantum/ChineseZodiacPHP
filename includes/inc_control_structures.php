<?php
    ...
    echo "  <a href='#if_else'>If... else statements</a>
            <a href='#switch'>Switch Statements</a>
            <a href='#while_loop'>While loop</a><a href='#for_loop'>For loop</a> ";
    ...
    echo "<a id='if_else'>If... else statements</a>
        ...
        <a href='includes/ShowSourceCode.php?source_file=inc_BirthYear_ifelse.php'>[View the Source]</a><br>";
    ...
    echo "<a id='switch'>Switch Statements</a>
        ...
        <a href='includes/ShowSourceCode.php?source_file=inc_BirthYear_switch.php'>[View the Source]</a><br>";
    ...
    echo "<a id='while_loop'>While Loop</a>
        ...
        <a href='includes/ShowSourceCode.php?source_file=inc_Chinese_Zodiac_while_loop.php'>[View the Source]</a><br>";
